...
## Repository map
- `bin/` — explain what lives here and when agents should edit it.
- `CHANGELOG.md/` — explain what lives here and when agents should edit it.
- `config/` — explain what lives here and when agents should edit it.
...
- `img/` — explain what lives here and when agents should edit it.
- `lib/` — explain what lives here and when agents should edit it.
